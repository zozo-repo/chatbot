...
const Footer = () => {
  return (
    <footer className="mt-20 pb-8">
      <GlassMorphicContainer className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              <img src="/placeholder.svg?height=48&width=48" alt="Lyallpur Khalsa College" className="h-12 w-auto" />
              <div className="ml-4">
