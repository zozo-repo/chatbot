...
const StatisticsSection = () => {
  const stats = [
    { id: 1, value: "5000+", label: "Students", icon: "users" },
    { id: 2, value: "200+", label: "Faculty Members", icon: "academic-cap" },
    { id: 3, value: "30+", label: "Years of Excellence", icon: "calendar" },
    { id: 4, value: "100+", label: "Companies Visit", icon: "office-building" },
    { id: 5, value: "85%", label: "Placement Rate", icon: "chart-bar" },
    { id: 6, value: "20+", label: "Advanced Labs", icon: "beaker" },
  ]
